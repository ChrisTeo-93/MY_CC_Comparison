                ...
                <div className="mt-2 space-y-2">
                  ...
                  {draft.earnRules.map((r, i) => (
                    <div key={i} className="rounded-lg border border-slate-200 p-2">
                      ...
                      <div className="mt-2 grid gap-2 sm:grid-cols-[1.4fr_1fr_.8fr]">
                        <input
                        ...
                        />
                        <input
                          placeholder="cap group id — same id = one shared cap"
                          title="Rules sharing this id pool ONE monthly cap between them. Leave blank unless the bank caps a group of categories jointly."
                          className={inputCls}
                          value={r.capGroup ?? ""}
                          onChange={(e) => patchRule(i, { capGroup: e.target.value || undefined })}
                        />
                        <input
                          type="number"
                          step="0.05"
